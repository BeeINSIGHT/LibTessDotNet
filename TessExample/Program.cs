...
namespace TessExample
{
    class Program
    {
        ...
        private static object VertexCombine(UnityEngine.Vector3 position, object[] data, float[] weights)
        {
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < numPoints; i++)
            {
                ...
                contour[i].Position = new UnityEngine.Vector3(inputData[i * 2], inputData[i * 2 + 1], 0.0f);
